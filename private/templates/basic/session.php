...
class Session extends Component {
    ...
    function get_prev_output($stop_comparator) {
        ...
        if (isset($_SESSION['PREV']) && is_array($_SESSION['PREV'])) {
            ...
            while ($prev && $stop_comparator !== $prev['comparator'] && isset($_SESSION['PREV'][$index])) {
                ...
                <div id="$prev_id" class="disabled" onclick="this.setAttribute('id', ''); window.location.href = '$prev_link'">
                </div>
                $prev_output
                </div>
                EOT;
