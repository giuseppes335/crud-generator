...
class Header extends Relation {
    ...
    function get() {
        ...
        */
        ...
        .field label, .field input[type=text], .field input[type=password], .field select, .field input[type=date] {
            display: block;
            width: 100%;
        }
        .field input[type=text], .field input[type=password], .field select, .field input[type=date] {
            height: 40px;
            line-height: 40px;
            font-size: 16px;
            margin-bottom: 8px;
